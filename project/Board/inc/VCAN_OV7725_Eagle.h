...
//配置摄像头顶层接口
//#define camera_init(imgaddr,Frames,Binaryzation)    ov7725_eagle_init(imgaddr,Frames,Binaryzation)   //camera_init(imgaddr)//
//#define camera_init(imgaddr)    ov7725_eagle_init(imgaddr)
#define camera_init(imgaddr,threshold)    ov7725_eagle_init(imgaddr,threshold)
...
extern  uint8   ov7725_eagle_init(uint8 *imgaddr,uint8 threshold);//ov7725_eagle_init(uint8 *imgaddr,uint8 Frames,uint8 Binaryzation);
