...
//      模块通道    端口          可选范围                          建议
#define UART0_RX_PIN    PTA15        //PTA1、PTA15、PTB16、PTD6          PTA1不要用（与Jtag冲突）
#define UART0_TX_PIN    PTA14        //PTA2、PTA14、PTB17、PTD7          PTA2不要用（与Jtag冲突）
...
#define UART3_RX_PIN    PTB10       //PTB10、PTC16、PTE5
#define UART3_TX_PIN    PTB11       //PTB11、PTC17、PTE4
...
#define FTM2_QDPHA_PIN  PTB18       //PTA10、PTB18
#define FTM2_QDPHB_PIN  PTB19       //PTA11、PTB19
...
#define SPI0_PCS1_PIN   PTD4        // PTC3、PTD4               全部都是 ALT2
#define SPI0_PCS2_PIN   PTD5        // PTC2、PTD5               全部都是 ALT2
#define SPI0_PCS3_PIN   PTD6        // PTC1、PTD6               全部都是 ALT2
